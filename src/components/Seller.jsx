          ...
          <div className='max-w-[1180px] mx-auto px-4'>
              <div className='flex items-center justify-between max-md:flex-wrap'>
                  <div className='max-md:text-center max-md:w-full'>
                      <h2 className='sbril-semi text-[39px] max-lg:text-4xl max-md:text-[28px] max-md:leading-9 max-md:pb-[14px] leading-[45px] text-[#0E1122] pb-5 max-w-[401px] max-md:mx-auto'>Become an 8 figure seller with AI funding</h2>
